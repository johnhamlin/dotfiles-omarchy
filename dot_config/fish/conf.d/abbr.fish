...
# Work laptop (RDP session must be up for ssh work / wkt to work)
abbr -a -- btwin 'xfreerdp3 /f /u:john.hamlin /d:BT /v:10.10.10.12 /sec:tls +fonts +themes +clipboard -wallpaper -window-drag -menu-anims -aero /dynamic-resolution /floatbar /scale:140 /gfx:RFX /auto-reconnect /auto-reconnect-max-retries:20'
abbr -a -- wk 'ssh work'
