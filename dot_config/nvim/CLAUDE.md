...
This is a LazyVim configuration for Neovim running on CachyOS Linux with Hyprland. The config extends LazyVim with custom plugins and integrations.
...
### Theme
- `theme.lua` - Hardcoded tokyonight-night colorscheme
